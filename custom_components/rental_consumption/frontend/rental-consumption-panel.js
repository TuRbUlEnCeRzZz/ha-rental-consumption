const TRANSLATIONS = {
  fr: {
    ...
    subtitle: "Enter the utility usage figures provided by the property management company or the landlord.",
    apartment: "Appartement",
    water: "Water",
    heating: "Heating",
    totalWater: "Total imported water",
    totalHeating: "Total imported heating",
    periods: "Recorded periods",
    addPeriod: "Add a period",
    type: "Type of consumption",
